...
if (
    ...
    $query = "UPDATE rooms SET room_title = '$room_title', bedroom_no = '$bedroom_no', kitchen_no = '$kitchen_no', hall_no = '$hall_no', location = '$location', room_desc = '$room_desc', rent = '$rent', isBalcony = '$isBalcony', isParking = '$isParking', owner_firstname = '$owner_firstname', owner_lastname = '$owner_lastname', phone_no = '$phone_no', email = '$email' WHERE id = '$room_id'";
    ...
    if (mysqli_query($connect, $query)) {
        ...
        $data = ['success' => true, 'message' => ['Room edited successfully']];
        echo json_encode($data);
    } else {
        $data = ['success' => false, 'message' => ['Room not edited!']];
        echo json_encode($data);
    }
} else {
